...
////////////
  ...
  Widget _buildList(){
    return Center(
            ...
            hint:  Text("Do you want to be Volunteer", style: TextStyle(color: Colors.deepPurple),),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Volunteer Registration") , centerTitle: true, backgroundColor: Colors.deepPurple),
      body:  Stack(
      children: <Widget>[
                  ...
                  Positioned(
                    child: taken
                        ? Container(
                            child: Center(
                              child: AlertDialog(
                                      title: Text('You are already registered as a volunteer,to change go to settings' ,
